...
export const settings = {
  ...
  webhooks: {
    ...
    urlLabel: "URL",
    urlPlaceholder: "https://example.com/hooks/thinkingface",
    // Shorter example for the narrower edit row (components/settings/webhook-row.tsx).
    urlPlaceholderEdit: "https://example.com/hook",
    eventsLabel: "Events",
